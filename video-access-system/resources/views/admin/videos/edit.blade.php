                ...
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('admin.videos.update', $video) }}">
                        ...
                        <div>
                            ...
                            <x-text-input id="title" class="block mt-1 w-full rounded-xl border-gray-200 focus:border-blue-500 focus:ring-blue-500 bg-gray-50/50" type="text" name="title" :value="old('title', $video->title)" required autofocus />
                        ...
                        <div class="mt-6">
                            ...
                            <x-text-input id="url" class="block mt-1 w-full rounded-xl border-gray-200 focus:border-blue-500 focus:ring-blue-500 bg-gray-50/50" type="url" name="url" :value="old('url', $video->url)" required />
                        ...
                        <div class="mt-6">
                            ...
                            <textarea id="description" name="description" class="block mt-1 w-full rounded-xl border-gray-200 focus:border-blue-500 focus:ring-blue-500 bg-gray-50/50 shadow-sm" rows="4">{{ old('description', $video->description) }}</textarea>
